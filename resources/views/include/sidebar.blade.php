        ...
        <li class="menu">
            ...
            <ul class="collapse submenu list-unstyled {{ show_class(['authentications/*']) }}" id="authentication" data-parent="#accordionExample">
                <li class=" {{ active_class(['authentications/style1/*']) }}">
                    ...
                    <ul class="collapse list-unstyled sub-submenu {{ show_class(['authentications/style1/*']) }}" id="pages-auth-one" data-parent="#authentication">
                        <li>
                ...
                <li class=" {{ active_class(['authentications/style2/*']) }}">
                    ...
                    <ul class="collapse list-unstyled sub-submenu {{ show_class(['authentications/style2/*']) }}" id="pages-auth-two" data-parent="#authentication">
                        <li>
                ...
                <li class=" {{ active_class(['authentications/style3/*']) }}">
                    ...
                    <ul class="collapse list-unstyled sub-submenu {{ show_class(['authentications/style3/*']) }}" id="pages-auth-three" data-parent="#authentication">
                        <li>
